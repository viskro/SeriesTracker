...
import { useEpisodeComment } from "../hooks/useEpisodeComment";
...
export default function AddEpisodeComment({ userId, episodeId }: Props) {
    const { content, setContent, isLoading, handleSubmit } = useEpisodeComment({ episodeId, userId });
