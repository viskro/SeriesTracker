...
CREATE TABLE `series_platforms` (
    ...
    INDEX `SeriesPlatforms_id_platform_fkey`(`id_platform`),
...
-- AddForeignKey
ALTER TABLE `series_platforms` ADD CONSTRAINT `series_platforms_id_platform_fkey` FOREIGN KEY (`id_platform`) REFERENCES `platforms`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `series_platforms` ADD CONSTRAINT `series_platforms_id_show_fkey` FOREIGN KEY (`id_show`) REFERENCES `shows`(`show_id`) ON DELETE RESTRICT ON UPDATE CASCADE;
